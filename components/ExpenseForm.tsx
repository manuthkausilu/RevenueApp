...
export interface ExpenseFormProps {
  ...
  editingExpense?: { id?: string; amount: number; description: string; date: string } | null;
  primaryColor?: string;
}
          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 12 }}>
              <View style={{
                ...
                <Ionicons name="receipt" size={22} color={primaryColor} />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 18, fontWeight: '700', color: primaryColor }}>
                  {editingExpense ? 'Edit Expense' : 'Add Expense'}
                </Text>
                <Text style={{ fontSize: 12, color: '#667085' }}>Track your spending</Text>
              </View>
            ...
            <ScrollView keyboardShouldPersistTaps="handled">
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                ...
                >
                  <Text style={{ color: '#fff', fontWeight: '700' }}>{editingExpense ? 'Update' : 'Add'}</Text>
                </TouchableOpacity>
              </View>
            </ScrollView>
          </View>
